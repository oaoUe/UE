...
# Q24 is at the bottom of left column
left_bot = arr[h//2:, :w//2]
save(left_bot, r"D:\大學\多益六回聽力\build\_t3\_p396_q24.png")

# Q25-27 on right column
right = arr[:, w//2:]
save(right, r"D:\大學\多益六回聽力\build\_t3\_p396_q25_27.png")
print("saved")
